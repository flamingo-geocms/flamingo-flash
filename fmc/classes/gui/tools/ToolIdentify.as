...
class gui.tools.ToolIdentify extends AbstractTool implements ComponentInterface
{
	...
	public function ToolIdentify(id:String, toolGroup:ToolGroup, container:MovieClip)
	{
		...
		this.defaultXML = "<?xml version='1.0' encoding='UTF-8'?>" + "<ToolIdentify>" + "<string id='tooltip' nl='informatie opvragen' en='identify'/>" + "<cursor id='cursor' url='fmc/CursorsMap.swf' linkageid='identify'/>" + "<cursor id='click'  url='fmc/CursorsMap.swf' linkageid='identify_click'/>" + "<cursor id='busy' url='fmc/CursorsMap.swf' linkageid='busy' />" + "</ToolIdentify>";
		init();
	}
