...
class gui.tools.ToolZoomin extends AbstractTool implements ComponentInterface
{
	...
	public function ToolZoomin(id:String, toolGroup:ToolGroup, container:MovieClip)
	{
		...
		this.defaultXML = "<?xml version='1.0' encoding='UTF-8'?>" + "<ToolZoomin>" + "<string id='tooltip' nl='inzoomen' en='zoom in'/>" + "<cursor id='cursor' url='fmc/CursorsMap.swf' linkageid='zoomin'/>" + "<cursor id='busy' url='fmc/CursorsMap.swf' linkageid='busy'/>" + "</ToolZoomin>";
		init();
	}
