...
No style id's<br/>
					...
					<xsl:choose>
						<xsl:when test="example">
							<p>
								<span class="bluebold">Example</span>
								<br/>
										...
										<xsl:when test="//configtag">
											<xsl:for-each select="//configtag">
												<table width="100%">
													...
													<tr>
														<td class="bluebold" width="130">Description</td>
														<td>
															<xsl:value-of select="description"/>
														</td>
													</tr>
													<tr>
														<td class="bluebold">Hierarchy</td>
														<td>
													...
													<xsl:choose>
														...
														<xsl:otherwise>
															<tr>
																<td class="bluebold">Attributes</td>
																<td>None</td>
															</tr>
														</xsl:otherwise>
													</xsl:choose>
