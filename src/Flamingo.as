...
class Flamingo {
	private var version:String = "4.2_beta_r3201";
			...
			if (this.isEmbeddedComponents(file)) {
				...
				if (this.components[targetid] != undefined && this.components[targetid] instanceof AbstractPositionable) {		
					...
					if (file == "ToolGroup") {
						...
						} else if (file == "ToolMapClick") {
							tool = new ToolMapClick(targetid, toolGroup, mc);	
						}
	...
	*/
	public function showCursor(cursor:Object):Void {
		...
		if (mc == undefined) {
			...
			this.mFlamingo.flamingoCursors._x  = _root._xmouse;
			this.mFlamingo.flamingoCursors._y =  _root._ymouse;
			mc.swapDepths(0);
			mc._visible = true;
