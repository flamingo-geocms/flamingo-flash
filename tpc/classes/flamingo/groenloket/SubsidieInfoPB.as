...
import flamingo.groenloket.SubsidieInfoConfig;
import flamingo.groenloket.GebisPakket;

class flamingo.groenloket.SubsidieInfoPB extends AbstractComponent {
      ...
      //flamingo.tracer("onIdentifyProgress: map = " + map + ",layersindentified = " + layersindentified + ", layerstotal = " + layerstotal + ", sublayersidentified = " + sublayersidentified + ", sublayerstotal = " + sublayerstotal);
		...
		function show() {
		  resize();
			...
			_visible = true;
			var parent = this;
			while (not _global.flamingo.isVisible(this) or parent != undefined) {
